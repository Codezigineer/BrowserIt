# BrowserIt
BrowserIt is a tiny (but powerful? and useful) library for interacting with browsers. 

## BIDs
BIDs are basically the thing that respond to the browsers, and you download them for usage and you provide the path to them when creating a `BID` instance.
